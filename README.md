...
![image-20230117110727554](https://res.ztion.cn/imgs/1673924848857.png)
...
- `[开发中]`**内容页面**：内容页面的卡片的修改和删除，以及一个统一控制排序的功能
...
- `[待研究]`**数据文件**：启动时检测安装目录数据数据文件是否存在，不存在则创建一个默认的

- `[待研究]`**导出**：将项目信息导出为Excel或者md
